...
parser.add_argument('--result-file','-o', type=argparse.FileType('w'), help='Write the mean of read length and mean of read span with the name RESULT. This test file is tab-delimited.');
...
if args.result_file is not None:
    print(str(int(round(readlenval[0]+readlenval[1]))) + '\t' + str(int(round(spanval[0]+spanval[1]))),file=args.result_file);
